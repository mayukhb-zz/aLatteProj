...
+ (void)dismiss
{
    // A system version of 5.0 or greater is required to use presentingViewController. 
...
- (void)show
{
	...
	[navItem setRightBarButtonItem:[[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(loginWithCredentialsFromDialog:)] autorelease]];
    ...
    [Common setUIViewTheme:self.view forTableView:[self tableView]];
